        ...
        <div className="max-w-screen-xl mx-auto space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button className="bg-[#16808D] hover:bg-[#142C52] text-white px-4 py-2 rounded-lg transition">
                Add New Course
              </button>
              <button className="bg-[#1B9AAA] hover:bg-[#16808D] text-white px-4 py-2 rounded-lg transition">
                View Users
              </button>
            </div>
          </div>
